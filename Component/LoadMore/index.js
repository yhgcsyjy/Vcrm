...
Component({
  ...
  methods: {
    ...
    //加载完成, 传入hasMore 
    loadMoreComplete: function (data,pagesize) {
      var hasMore = data.data.data.length > 0 && data.data.data.length == pagesize;//data.curPage < data.pageCount && data.pageCount != 1
