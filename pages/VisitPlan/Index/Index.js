// pages/VisitPlan/Index/Index.js
...
Page({
  ...
  data: {
    ...
    visitPlanUrl: '../Detail/Index?visitPlanId=',
    scrollHeight: 400,
  },
  ...
  getData(_where) {
    ...
    _HTTP.Get({ url: "api/VisitPlan/GetPageList", data: data }).then(res => {
      var items = this.data.visitPlanList
